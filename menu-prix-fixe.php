	...
	<div class="wrapper fade-in">
		...
		<div>
			<section class="mobile-sub-menu">
				...
				<span>
					<a class="active" href="menu-prix-fixe.php">prix fixe</a>					
				</span>
			</section>
			...
			<article>
				...
				<!-- use &nbsp; or class="less-width" to control widows before using <br> -->
